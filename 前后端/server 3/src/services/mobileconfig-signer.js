...
const DATA_DIR = path.join(__dirname, '../../data/ssl');
const SSL_CERT = process.env.SSL_CERT_PATH || path.join(DATA_DIR, 'fullchain.pem');
const SSL_KEY = process.env.SSL_KEY_PATH || path.join(DATA_DIR, 'privkey.key');
const SSL_CHAIN = process.env.SSL_CHAIN_PATH || path.join(DATA_DIR, 'chain.pem');
